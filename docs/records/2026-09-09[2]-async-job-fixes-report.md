...
> **Состояние на 2026-09-09:** A–E выполнены в незакоммиченном дереве.
> Три итоговые проверки зелёные, обе обязательные мутации пойманы.
> Коммит делает владелец; примеры остаются следующей задаче.
