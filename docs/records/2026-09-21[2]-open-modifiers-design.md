...
> в §8. Обещание оказалось половинчатым: `AsyncControllerScope` двойник
> контроллера не принимал, это закрыто в тот же день, `33d5003`, и вышло
> как 0.15.1.
...
> работа этого дня), `2026-09-21[4]-mockable-controller-scope-report.md`
> (там обещание этой работы доведено до сцены).
