...
> **Состояние на 2026-09-09:** спека написана, **Р1–Р4 решены владельцем в
> тот же день** — реэкспортировать выборочно, публичный `ScopeInitJob<T>`,
> `isCancelled` убрать, принять правило ядра. Р5–Р7 идут по рекомендациям.
> Работа передана исполнителю (`codex`), приёмка своя.
