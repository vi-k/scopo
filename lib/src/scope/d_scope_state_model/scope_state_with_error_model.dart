...
base class ScopeStateWithErrorNotifier<S extends Object>
  ...
  @override
  UnmodifiableScopeStateModelWithError<S> asUnmodifiable() =>
      UnmodifiableScopeStateModelWithError(this);
}

base class UnmodifiableScopeStateModelWithError<S extends Object>
    extends UnmodifiableScopeStateModel<S>
    implements ScopeStateWithErrorModel<S> {
  UnmodifiableScopeStateModelWithError(
