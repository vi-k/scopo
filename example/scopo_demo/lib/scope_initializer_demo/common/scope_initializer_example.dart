...
class _ScopeInitializerExampleState extends State<ScopeInitializerExample> {
  ...
  Widget build(BuildContext context) => Expansion(
        ...
        title: const Markdown(
          Constants.exampleTitle,
          selectable: false,
        ),
        children: [
          Wrap(
              ...
              TitledBoxList(
                ...
                children: [
                  ...
                  FilledButton(
                    ...
                    child: const Text('Next with error'),
                  ),
                ],
              ),
                  ...
                  children: [
                    for (var i = 0; i < widget.consumersCount; i++)
                      _Consumer(
                        ...
                        builder: (context, log) =>
                            widget.builder(context, _withError, log),
                      ),
                  ],
                ),
              ),
...
class _ConsumerState extends State<_Consumer> {
  ...
  Widget build(BuildContext context) {
    ...
    return !widget.isEnabled
        ? TitledBox(
            title: title,
            child: const Center(child: Text('removed from widget tree')),
          )
        : Consumer(
            title: title,
              ...
              builder: (context, value, child) {
                final content = Column(
                  ...
                  children: [
                    ...
                    for (final log in value.take(_lastLogBuildedCount))
                      Text(log),
