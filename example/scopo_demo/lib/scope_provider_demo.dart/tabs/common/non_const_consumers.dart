...
class NonConstConsumers extends StatelessWidget {
  ...
  NonConstConsumers({
    super.key,
    required this.selectA,
    required this.selectB,
  });

  @override
  Widget build(BuildContext context) {
    return BoxList(
      title: Constants.nonConstConsumersTitle,
      ...
      children: [
        Center(child: Markdown('This is **not** a consumer')),
        BoxList(
          title: 'Non-constant child',
          titleBackgroundColor: Theme.of(context).colorScheme.tertiary,
          titleForegroundColor: Theme.of(context).colorScheme.onTertiary,
          blinkingColor: Theme.of(context).colorScheme.primary,
          children: [
            Center(
              child: Markdown('This is **not** a consumer'),
            ),
            Column(
              spacing: 8,
              children: [
