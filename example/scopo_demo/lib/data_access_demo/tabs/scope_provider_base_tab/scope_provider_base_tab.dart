  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Markdown(
          '''
          # ScopeProviderBase, ScopeNotifierBase

          `ScopeProviderBase` and `ScopeNotifierBase` are abstract base classes
          ...
          children: [
            Code(
              ...
              final class ModelScope extends ScopeNotifierBase<ModelScope, Model> {
                ...
                static ScopeProviderContext<ModelScope, Model> get(
                  BuildContext context,
                ) =>
                    ScopeNotifierBase.get<ModelScope, Model>(context);

                static ScopeProviderContext<ModelScope, Model> depend(
                  BuildContext context,
                ) =>
                ...
                static V select<V extends Object?>(
                  BuildContext context,
                  V Function(ScopeProviderContext<ModelScope, Model> e) selector,
                ) =>
