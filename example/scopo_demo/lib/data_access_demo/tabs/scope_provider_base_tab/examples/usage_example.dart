...
final class ModelScope extends ScopeNotifierBase<ModelScope, Model> {
  ...
  static ScopeContext<ModelScope, Model> get(BuildContext context) =>
      ScopeNotifierBase.of<ModelScope, Model>(context, listen: false);

  static ScopeContext<ModelScope, Model> depend(BuildContext context) =>
...
class _UsageState extends State<Usage> {
  ...
  @override
  Widget build(BuildContext context) => ModelScope(
...
class _CounterState extends State<_Counter> {
  ...
  @override
  Widget build(BuildContext context) => Text('i=${++i}');
}
