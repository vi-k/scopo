...
enum ScopeStateBuilderExampleState { initial, inProgress, success, error }

class ScopeStateBuilderExample extends StatelessWidget {
  const ScopeStateBuilderExample({super.key});
                ...
                ListenableBuilder(
                  ...
                  builder: (context, _) {
                    return TitledBoxList(
                      ...
                      children: [
                        for (final state
                            in ScopeStateBuilderExampleState.values)
                          FilledButton(
...
class _ConstConsumer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Box(
      ...
      child: Text(state.name, textAlign: TextAlign.center),
    );
  }
}
